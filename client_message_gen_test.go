...
func TestMarshalUnmarshalFN(t *testing.T) {
	v := FN{}
...
func BenchmarkMarshalMsgFN(b *testing.B) {
	v := FN{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgFN(b *testing.B) {
	v := FN{}
...
func BenchmarkUnmarshalFN(b *testing.B) {
	v := FN{}
